...
- Serverless executions have time and memory limits (currently 300s / 2GB on the default Vercel plan). Long-running ffmpeg/transcribe jobs may need tighter chunking or a higher Vercel plan.
